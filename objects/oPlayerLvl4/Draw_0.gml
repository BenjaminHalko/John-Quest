...
if (global.playerSpriteIsCustom) {
    draw_sprite_ext(global.playerCustomSprite,0,x,y+_y,1/yscale,_yscale,_spriteAngle,image_blend,image_alpha);
    draw_sprite_ext(sprite_index,1,x,y+_y,1/yscale,_yscale,_spriteAngle,image_blend,image_alpha);
} else {
    draw_sprite_ext(sprite_index,0,x,y+_y,1/yscale,_yscale,_spriteAngle,image_blend,image_alpha);
}
