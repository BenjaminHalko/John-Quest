...
draw_text_ext((x1+x2)/2+_portrait*24, y1+8+global.fontRPGYOffset, _print, 14, 999);
draw_set_color(c_white);
draw_text_ext((x1+x2)/2+_portrait*24, y1+7+global.fontRPGYOffset, _print, 14, 999);
